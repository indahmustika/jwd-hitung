	...
	<nav class="navbar navbar-expand-lg navbar-light bg-gray shadow">
		<div class="container">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link active" href="faktorial-input.php">Hitung Faktorial</a></li>
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="card shadow">
					<h5 class="card-header bg-white text-dark">Perhitungan Faktorial</h5>
					<div class="card-body">
						<form action="faktorial-post.php" method="POST">
							<div class="row">
								<div class="col-sm-6"><input type="number" name="angka" class="form-control" placeholder="Masukkan angka" required></div>
								<div class="col-sm-2"><input type="submit" class="btn btn-primary shadow" value="Hitung"></div>
							</div>
						</form>
						<?php if(isset($_GET['angka'])){ ?>
							<div class="alert alert-success shadow" role="alert">
								<div class="alert-heading">Hasil Faktorial</div>
								<hr><h5><strong></strong><?php echo $_GET['angka']?>! = <?php echo $_GET['hasil']?></h5>  
							</div>
						<?php }?>
					</div>
				</div>
